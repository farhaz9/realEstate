      ...
      <div className="container mx-auto px-4 py-16">
        <Card className="max-w-4xl mx-auto">
          ...
          <CardContent className="prose prose-lg max-w-none">
            ...
            <p>
              All content on this website, including text, graphics, logos, and software, is the property of Falcon Estates or its content suppliers and is protected by intellectual property laws.
            </p>
            
            <h2>6. Limitation of Liability</h2>
            <p>
              Falcon Estates will not be liable for any damages of any kind arising from the use of this site, including, but not limited to direct, indirect, incidental, punitive, and consequential damages.
            </p>
            ...
            <p>
             ...
             <h2>8. Contact Us</h2>
            <p>
              If you have any questions about these Terms, please contact us at contact@falconestates.com.
            </p>
          </CardContent>
        </Card>
      </div>
