    ...
    return (
        <div className="py-8">
            <div className="text-center mb-8">
             ...
             <Card className="max-w-md w-full mx-auto shadow-2xl shadow-primary/10 bg-gradient-to-br from-primary/10 to-accent/50 relative overflow-hidden rounded-3xl border-0">
                <CardContent className="p-8 text-center">
                     <div className="absolute top-4 right-4 bg-black/10 text-primary-foreground text-xs font-bold uppercase px-3 py-1 rounded-full flex items-center gap-1 shadow-lg backdrop-blur-sm">
                    ...
                    <h3 className="text-xl font-semibold text-primary">Buy Listing Credit</h3>
                    <div className="my-4">
                        <span className="text-6xl font-extrabold tracking-tighter text-foreground">
                            {formatPrice(price)}
                        </span>
                    </div>
                     <div className="inline-block bg-primary/10 backdrop-blur-sm text-primary text-sm font-medium px-4 py-1.5 rounded-full">
                        per premium listing
                    </div>
