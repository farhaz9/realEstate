  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-full border-l origin-top-right data-[state=closed]:zoom-out-90 data-[state=closed]:fade-out-0 data-[state=open]:zoom-in-90 data-[state=open]:fade-in-0",
      },
    },
    defaultVariants: {
      side: "right",
